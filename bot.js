...
const gmuteon = {
    "embed": {
      ...
      "fields": [
        {
          "name": "<:emoji_vert:561463156434796545> Mute Global",
          "value": "Cette option permet de rendre tout le monde muet, partout"
        },
        {
          "name": "JeuxGate - Jéhèndé#3800",
          "value": "<:emoji_rouge:561463105083670528> programme inactif - <:emoji_bleu:561463041028390922> chargement du programme - <:emoji_vert:561463156434796545> programme en cours"
        }
      ]
    }
  }
...
const gmuteoff = {
    "embed": {
      ...
      "fields": [
        {
          "name": "<:emoji_bleu:561463041028390922> Mute Global",
          "value": "Cette option permet de rendre tout le monde muet, partout"
        },
        {
          "name": "JeuxGate - Jéhèndé#3800",
...
const gmuteomaybe = {
    "embed": {
      ...
      "fields": [
        {
          "name": "<:emoji_rouge:561463105083670528> Mute Global",
          "value": "Cette option permet de rendre tout le monde muet, partout"
        },
        {
          "name": "JeuxGate - Jéhèndé#3800",
