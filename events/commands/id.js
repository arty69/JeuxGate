...
exports.run = async (message) =>{
    ...
    if (message.client.users.cache.get(idserched)) {
        message.channel.send('Utilisateur avec id `' + idserched + '` trouvé, voici son nom d\'utilisateur : `' + message.client.users.cache.get(idserched).username + '`.\r\n***Pour des raisons de confidentialitées, le discriminant*** `#----` ***n\'est pas cité.***')
